...
describe('Notificacion routing resolve service', () => {
  ...
  let resultNotificacion: INotificacion | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultNotificacion).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<INotificacion>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
